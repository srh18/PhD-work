...
value = loadbigpR1(1,4*pi,0);
clf
value.plot_period(300)
ylim([0.5,1.7])
ylim([0.5,1.75])
saveas(figure(22),'../plots/psbigp/waveperioddel1L4pi','epsc')
value = loadbigpR1(1,5.25*pi,0);
clf
value.plot_period(300)
...
plot(value.z,306.3+0*value.z,'r--','LineWidth',2,'DisplayName','Peak 1 at wall peak')
plot(value.z,313.7+0*value.z,'r-.','LineWidth',2,'DisplayName','Peak 1 at wall trough')
plot(value.z,315.1+0*value.z,'m--','LineWidth',2,'DisplayName','Peak 2 at wall peak')
plot(value.z,322.5+0*value.z,'m-.','LineWidth',2,'DisplayName','Peak 2 at wall trough')
plot(value.z,306.3+17.6+0*value.z,'r--','LineWidth',2,'HandleVisibility','off')
plot(value.z,322.5-17.6+0*value.z,'m-.','LineWidth',2,'HandleVisibility','off')

legend('NumColumns',3,'Location','northwest')
...
ylim([300 320])
plot(value.z,302.6+0*value.z,'r--','LineWidth',2,'DisplayName','Peak at wall peak')
plot(value.z,309.2+0*value.z,'r-.','LineWidth',2,'DisplayName','Peak at wall trough')
plot(value.z,302.6+11.3+0*value.z,'r--','LineWidth',2,'HandleVisibility','off')
...
plot(smooth(smooth(value.z(l2),7),7),value.t,'g:','LineWidth',2,'DisplayName','Trough location')
ylim([300 315])
plot(value.z,305+0*value.z,'r--','LineWidth',2,'DisplayName','Peak at wall peak')
plot(value.z,301.7+0*value.z,'r-.','LineWidth',2,'DisplayName','Peak at wall trough')
plot(value.z,301.7+7.6+0*value.z,'r-.','LineWidth',2,'HandleVisibility','off')
plot(value.z,305+7.6+0*value.z,'r--','LineWidth',2,'HandleVisibility','off')
...
%h2 plots
value = loadbigpR1(0,4*pi,0);
value.ploth2
hold on 
value = loadbigpR1(0.1,4*pi,0);
value.ploth2
value = loadbigpR1(1,4*pi,0);
value.ploth2
...
saveas(figure(28),'../plots/psbigp/L91f','epsc')
...
figure
v3b.surfdata(9*pi/T,4)
v3b.surfdata(9*pi/T)
[npks,time_periodic,c,T] = v3b.get_peak_info(1600)
v3b.surfdata(9*pi/T)
clf
v3.plot_fourier_modes
saveas(figure(28),'../plots/psbigp/L93curvef','epsc')
hold on
...
[npks,time_periodic,c,T] = v2b.get_peak_info(300)
hold on
v1.ploth2
v2b.animate_new
figure
...
hold on
v3b.ploth2
saveas(figure(22),'../plots/psbigp/L92close','epsc')
...
v1.surfdata(c,-10)
ylim([300,400])
saveas(figure(25),'../plots/psbigp/L91','epsc')